...
export const hm: Question[] = [
  ...
  },
  {
    ...
    answer: [
      ...
      'For an EU audience, pick or configure the RUM tool with GDPR in mind: avoid collecting personal data (IP, precise identifiers) beyond what is needed, prefer an EU-hosted or anonymized setup, and confirm whether it needs to be declared in a cookie/consent banner before it fires for a given user.',
    ],
    keyPoints: [
      ...
      'Considers GDPR/consent implications of the RUM tool itself',
    ],
  ...
  },
  {
    ...
    answer: [
      ...
      'In Germany, be aware that any tooling tracking per-person metrics (individual review turnaround, PR counts) can fall under the works council\'s co-determination right on employee monitoring systems (§87 BetrVG) — aggregate, team-level metrics avoid this; anything reported per-individual should go through Betriebsrat sign-off first.',
    ],
    keyPoints: [
      ...
      'Flags the Betriebsrat/§87 BetrVG angle on any per-individual metric',
    ],
  ...
  },
  {
    ...
    answer: [
      ...
      'If this were rolled out at a German company, name the compliance step up front: a bot naming individuals and their turnaround times is exactly the kind of employee-monitoring tool the works council has co-determination rights over (§87 BetrVG), so it would need Betriebsrat agreement before shipping, or should report team-level numbers only.',
    ],
    keyPoints: [
      ...
      'Names the Betriebsrat/§87 BetrVG step needed before naming individuals',
    ],
