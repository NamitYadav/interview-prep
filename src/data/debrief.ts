...
export const debrief: Question[] = [
  ...
  },
  {
    ...
    keyPoints: [
      ...
      'Owns any inconsistency in the codebase rather than hiding it',
      'Avoids defending inconsistency as if it were intentional',
    ],
  ...
  },
  {
    ...
    answer: [
      ...
      'Either way, connect the decision to the actual purpose of a take-home: demonstrating judgment about tool selection at the given scale, not defaulting to "always use a library" or "always build from scratch" as a rule.',
    ],
    keyPoints: [
      'Gives a specific, honest reason for the choice made either way',
      'If a library was used, names exactly which gap it closed',
      'If not used, names what was built by hand instead and why',
      'Frames the choice as scale-appropriate judgment, not a blanket rule',
    ],
  ...
  },
  {
    ...
    keyPoints: [
      ...
      'Gives the real reason: a time-box trade-off against a named higher priority',
      'States concretely what adding it would require',
      'Reads as deliberate sequencing, not an unnoticed gap',
    ],
    followUps: ['If you had one more hour, would you have added it or something else?', 'How would you have flagged this omission in the README if asked to?'],
  },
  {
    id: 'debrief-007',
    round: 'debrief',
  ...
  },
  {
    ...
    followUps: ['Where would a new contributor be confused by this structure first?', 'How would this change with a second, unrelated feature area?'],
  },
  ...
  },
  {
    ...
    keyPoints: [
      ...
      'Frames it as extrapolation, not a claim the take-home needed this scale',
    ],
  ...
  },
  {
    ...
    keyPoints: [
      ...
      'Treats flagging a known risk as a legitimate answer, not an admission of failure',
    ],
  ...
  },
  {
    ...
    round: 'debrief',
    category: 'Reflection',
    question: 'What are you least proud of?',
    answer: [
      'Pick one real, specific thing — a piece of code you know is not clean, a shortcut you took under time pressure, or a corner you cut in testing — rather than a deflection ("I am proud of all of it") or false modesty about something actually fine.',
      'Explain briefly why it happened: almost always a time-box trade-off, not a skill gap, and name what you would have done differently with more time so the answer reads as self-aware rather than apologetic.',
      'Keep the tone matter-of-fact: staff-level candidates are expected to know exactly where their own work is weakest, so this question is a credibility check, not a trap — treating it as one and deflecting reads worse than a direct, specific answer.',
    ],
    keyPoints: [
      'Names one real, specific weak point, not a deflection or false modesty',
      'Explains it as a time-box trade-off, not a skill gap',
      'States what would have been done differently with more time',
      'Keeps a matter-of-fact tone rather than sounding apologetic or evasive',
    ],
  ...
  },
  {
    ...
    keyPoints: [
      ...
      'Shows how the learning actually changed a decision mid-build, if applicable',
      'Keeps the answer short and single-example rather than a long list',
      'Avoids a generic "I learned a lot" non-answer',
    ],
  ...
  // From your CV (5)
  {
    ...
    question: 'You have led large migrations: how would you migrate this take-home to a new framework version safely?',
    answer: [
  ...
  },
  {
    ...
    round: 'debrief',
    category: 'From your CV',
    question: 'You built quality gates in CI: what gates would you add to this repo and in what order?',
    answer: [
    ...
    keyPoints: [
      ...
      'Avoids a generic, un-reasoned list of "add CI, add tests, add lint"',
    ],
  ...
  },
  {
    ...
    round: 'debrief',
    category: 'From your CV',
    question: 'Given your feature-flag experience, how would you roll this feature out to real users?',
    answer: [
  ...
  },
  {
    ...
    round: 'debrief',
    category: 'From your CV',
    question: 'You introduced e2e testing at a previous company: which three e2e tests would you write here?',
    answer: [
